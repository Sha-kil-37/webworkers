...
export default function ChooseUs() {
  ...
  return (
    <motion.section
      ...
      className="xl:py-10 overflow-hidden lg:py-10 md:py-10"
    >
      <div className="xl:w-6xl xl:mx-auto lg:w-5xl lg:mx-auto md:px-6 md:mx-auto">
        <h2 className="text-3xl font-bold text-center max-w-3xl mx-auto font-primary xl:tracking-wide lg:text-3xl lg:tracking-wide md:text-2xl md:tracking-wide">
        ...
        <div className="xl:grid xl:grid-cols-4 xl:mt-10 lg:grid lg:grid-cols-4 lg:mt-8 md:mt-8 md:grid md:grid-cols-2 md:gap-x-12 md:gap-y-6">
          {features.map((item, i) => {
            ...
            return (
              <motion.div
                ...
                className="xl:p-4 lg:p-4 md:p-6"
              >
                <Icon className="xl:h-13 xl:w-13 xl:mx-auto text-[#0076DF] lg:w-12 lg:h-12 lg:mx-auto md:mx-auto md:h-10 md:w-10" />
                <Paragraph className="xl:text-2xl mt-5 text-center font-medium font-primary tracking-wide lg:text-xl lg:mt-4 lg:tracking-wide md:text-lg md:mt-4 md:tracking-wide">
                  {item.title}
                </Paragraph>
              </motion.div>
            );
