        ...
        <div className="xl:grid xl:grid-cols-4 xl:mt-10 lg:grid lg:grid-cols-4 lg:mt-8 md:mt-8 md:grid md:grid-cols-2 md:gap-x-10 sm:mt-5 sm:grid sm:grid-cols-2 sm:gap-x-10">
          {features.map((item, i) => {
            ...
            return (
              ...
              >
                <Icon className="xl:h-13 xl:w-13 xl:mx-auto  lg:w-12 lg:h-12 lg:mx-auto md:mx-auto md:h-10 md:w-10 sm:h-10 sm:w-10 sm:mx-auto" />
                <Paragraph className="font-primary text-center mt-4 font-semibold tracking-wide text-[#0076DF]">
                  {item.title}
                </Paragraph>
              </motion.div>
            );
