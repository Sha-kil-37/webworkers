...
export default function Banner() {
  ...
  return (
    <motion.section
      id="home"
      className="relative overflow-hidden 2xl:pt-50 2xl:pb-15 xl:pt-45 xl:pb-15 lg:pt-40 lg:pb-14 md:pt-40 md:pb-12 sm:pt-40 sm:pb-10 pt-22 pb-5"
    >
      <div className="relative xl:w-6xl xl:mx-auto lg:w-5xl lg:mx-auto md:mx-auto md:px-6 sm:px-6 sm:mx-auto mx-auto px-1 text-wrap">
        <TextFlip
