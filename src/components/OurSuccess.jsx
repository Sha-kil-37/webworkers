...
export default function OurSuccess() {
  ...
  return (
    <motion.section
      ...
      className="2xl:py-15 xl:py-15 relative lg:py-15 md:py-15 sm:py-8"
    >
      <div className="xl:w-6xl xl:mx-auto xl:grid xl:grid-cols-2 xl:gap-x-40 2xl:grid 2xl:grid-cols-2 2xl:gap-12 lg:w-5xl lg:mx-auto lg:grid lg:grid-cols-2 lg:gap-x-20 md:px-8 md:grid md:grid-cols-2 md:gap-x-20 sm:px-8 sm:mx-auto sm:grid sm:grid-cols-2 sm:gap-x-15 mx-auto px-4">
        <div className="">
          <h2 className="tracking-wide font-bold font-primary  2xl:text-4xl xl:text-4xl lg:text-4xl md:text-3xl sm:text-3xl mx-auto text-2xl">
            Our <span className="text-[#0076DF]">Success</span>
          </h2>
          <div className="flex 2xl:justify-start xl:justify-start lg:justify-start md:justify-start sm:justify-start">
          ...
          {/*  */}
          <Paragraph className="font-primary 2xl:text-left xl:text-left lg:text-left md:text-left sm:text-left mt-3 tracking-wide">
