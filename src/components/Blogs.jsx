        ...
        <div className="xl:grid xl:grid-cols-2 xl:gap-12 lg:grid lg:grid-cols-2 lg:gap-x-10 md:gap-10 md:grid md:grid-cols-2 sm:grid sm:grid-cols-2 sm:gap-x-4">
          ...
          <aside className="md:col-span-1 xl:border-r 2xl:border-r lg:border-r  border-[#F5F5F7] md:border-r sm:border-r">
            <div className="2xl:sticky 2xl:top-18 xl:sticky xl:top-18 lg:sticky lg:top-18 md:top-18 md:sticky sm:top-18 sm:sticky">
              <h2 className="tracking-wide font-bold font-primary 2xl:text-left xl:text-left lg:text-left md:text-left sm:text-left 2xl:text-4xl xl:text-4xl lg:text-4xl md:text-3xl sm:text-3xl mx-auto mb-2 text-2xl">
                Read Our <span className="text-[#0076DF]">Blogs</span>
              </h2>
              <Paragraph className="font-primary w-full mt-3 2xl:text-left xl:text-left lg:left-left md:text-left sm:text-left tracking-wide">
